...
describe('<DeleteJobModal>', () => {
  it('renders without errors', () => {
    ...
    shallow( /*#__PURE__*/React.createElement(DeleteJobModal, props));
  });
  it('calls hideModal when cancel button is clicked', () => {
    ...
    const wrapper = mount( /*#__PURE__*/React.createElement(DeleteJobModal, props));
  ...
  it('calls deleteJob, onSuccess and hideModal when delete button is clicked', async () => {
    ...
    await deletion;
    expect(deleteJobSpy).toHaveBeenCalledWith({
      id: 'id'
    });
