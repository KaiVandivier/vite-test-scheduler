...
describe('<RunJobModal>', () => {
  it('renders without errors', () => {
    useDataMutation.mockImplementation(() => [jest.fn(), {
      loading: false,
      error: null
    }]);
    const props = {
    ...
    shallow( /*#__PURE__*/React.createElement(RunJobModal, props));
  });
  it('calls hideModal when cancel button is clicked', () => {
    ...
    const wrapper = mount( /*#__PURE__*/React.createElement(RunJobModal, props));
